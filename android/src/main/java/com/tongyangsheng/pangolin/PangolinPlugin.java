...
public class PangolinPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    private void onAttachedToEngine(Context applicationContext, BinaryMessenger messenger) {
        ...
        methodChannel = new MethodChannel(messenger, "com.luoyang.ad.pangolin");
        methodChannel.setMethodCallHandler(this);

        eventChannel = new EventChannel(messenger, "com.luoyang.ad.pangolin.event");
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        if (call.method.equals("register")) {
            ...
            String mCodeId = call.argument("slotId");
            Boolean deBug = call.argument("debug");
            ...
            if (isHorizontal == null) {
                ...
                RewardVideoActivity.eventSink = eventSink;
                if (isHorizontal) {
                    Intent intent = new Intent();
